    ...
    <div v-if="!isLoadingInitial" class="uk-card uk-card-default uk-width-4-5@m uk-align-center">
            ...
            <div v-if="dados.atividade">
                <div class="uk-clearfix">
                    ...
                    <div class="uk-float-right">
                        <a @click.prevent.stop="apagarAtividadeMateria()" class="i-remove" uk-icon="trash"></a>
                    </div>
                </div>
        ...
        <div v-if="dados.atividade">
            ...
            <div class="uk-card-footer">
                <div class="uk-clearfix">
                    <div class="uk-float-left">
                        <router-link :to="{name: 'editarAtividadeMateria', params: {id: dados.id}}" class="uk-button uk-button-primary">Editar</router-link>
                    </div>
                    <div class="uk-float-right">
    ...
    methods: {
        async concluirAtividade() {
            try {
                ...
                let response = await this.$http.put(process.env.API_URL + 'atividade-materia/update/' + this.id, atividade, {headers: {Authorization: token}});
            ...
            try {
                ...
                this.$swal.fire({
                    ...
                    if (result.value) {
                        ...
                        // Salva os cursos e as matérias
                        let response = await this.$http.delete(process.env.API_URL + `atividade-materia/delete//${this.dados.atividade.id}`, {headers: {Authorization: token}});
