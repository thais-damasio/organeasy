    ...
    <div v-if="!isLoadingInitial" class="uk-card uk-card-default uk-width-4-5@m uk-align-center">
            ...
            <div v-if="dados.atividade">
                <div class="uk-clearfix">
                    ...
                    <div class="uk-float-right">
                        <a @click.prevent.stop="apagarAtividadeCurso()" class="i-remove" uk-icon="trash"></a>
                    </div>
                </div>
        ...
        <div v-if="dados.atividade">
            ...
            <div class="uk-card-footer">
                <div class="uk-clearfix">
                    <div class="uk-float-left">
                        <router-link :to="{name: 'editarAtividadeCurso', params: {id: dados.id}}" class="uk-button uk-button-primary">Editar</router-link>
                    </div>
                    <div class="uk-float-right">
...
export default {
    ...
    methods: {
        ...
        loadAtividadeCurso() {
            let token = this.$session.get('jwt');
            // Carrega os cursos
            this.$http.get(process.env.API_URL + 'atividade-curso/get/' + this.id, {headers: {Authorization: token}})
            .then(
            atividade => {
