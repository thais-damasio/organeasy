            ...
            <form @submit.prevent.stop="cadastrarCurso()">
                <div class="uk-card-body">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                <label><input class="uk-radio" type="radio" v-model="curso.tem_materias"
                                        name="radio2" :value="true"> Sim</label>
                                <label><input class="uk-radio" type="radio"  v-model="curso.tem_materias"
                                        name="radio2" :value="false"> Não</label>
                            </div>
                    ...
                    <ul v-if="curso.tem_materias" uk-accordion>
                        <li>
                            <a class="uk-accordion-title uk-button-accordion-li uk-background-muted uk-padding-small" href="#">Matérias</a>
                            <div class="uk-accordion-content">
                                <ul v-if="curso.materias.length > 0" class="uk-list uk-list-striped">
                                    <li v-for="(materia, index) in curso.materias" :key="index">
                                        <span class="i-remove" @click="removeMateria(index)" uk-icon="close"></span>&emsp;
                                        {{materia.nome}}
                                    </li>
                                </ul>
            ...
            if (!this.$v.$invalid && !this.registerCurso) {
                try {
                    ...
                    for(let i = 0; i < this.curso.materias.length; i++){
                        ...
                        materia.id_courso = response.body.data.id;
